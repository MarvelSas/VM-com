...
//Add products
        ...
        productRepository.save(new Product(
                ...
                10999.00,
                Arrays.asList("macbook1.jpg", "macbook2.jpg", "macbook3.jpg"),
                0,
                5L,
                productCategory1
        ));
        ...
        productRepository.save(new Product(
                ...
                8499.00,
                Arrays.asList("dellxps1.jpg", "dellxps2.jpg", "dellxps3.jpg"),
                0,
                6L,
                productCategory1
        ));
        ...
        productRepository.save(new Product(
                ...
                9999.00,
                Arrays.asList("hp1.jpg", "hp2.jpg", "hp3.jpg"),
                0,
                7L,
                productCategory1
        ));
        ...
        productRepository.save(new Product(
                ...
                4699.00,
                Arrays.asList("tab1.jpg", "tab2.jpg", "tab3.jpg", "tab4.jpg"),
                0,
                11L,
                productCategory3
        ));
        ...
        productRepository.save(new Product(
                ...
                4299.00,
                Arrays.asList("ipadpro1.jpg", "ipadpro2.jpg"),
                0,
                12L,
                productCategory3
        ));
        ...
        productRepository.save(new Product(
                ...
                3599.00,
                Arrays.asList("matepad1.jpg", "matepad2.jpg", "matepad3.jpg"),
                0,
                13L,
                productCategory3
        ));
        ...
        productRepository.save(new Product(
                ...
                9999.00,
                Arrays.asList("rog1.jpg", "rog2.jpg", "rog3.jpg"),
                0,
                17L,
                productCategory1
        ));
        ...
        productRepository.save(new Product(
                ...
                1299.00,
                Arrays.asList("razerblackshark1.jpg", "razerblackshark2.jpg", "razerblackshark3.jpg"),
                0,
                18L,
                productCategory2
        ));
